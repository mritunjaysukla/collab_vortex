...
let AuthController = class AuthController {
    ...
    async confirmPasswordReset(confirmResetPasswordDto) {
        return await this.authService.confirmPasswordReset(confirmResetPasswordDto.token, confirmResetPasswordDto.newPassword);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Confirm password reset with token' }),
