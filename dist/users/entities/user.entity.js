...
__decorate([
    (0, typeorm_1.OneToOne)(() => creator_profile_entity_1.CreatorProfile, (profile) => profile.user, { cascade: true }),
    __metadata("design:type", creator_profile_entity_1.CreatorProfile)
], User.prototype, "creatorProfile", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => brand_profile_entity_1.BrandProfile, (profile) => profile.user, { cascade: true }),
    __metadata("design:type", brand_profile_entity_1.BrandProfile)
], User.prototype, "brandProfile", void 0);
